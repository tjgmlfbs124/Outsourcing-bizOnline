...
<html class="no-js" lang="en">
   ...
   <script>
      ...
      function update(){
        ...
        //$("#carrier-support-02").text(numberWithCommas(localDataSet['subscription'].support_fund_price));
        console.log("optiona_price : "+localDataSet['subscription'].support_fund_price);
