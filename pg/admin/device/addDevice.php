          ...
          <form id="signForm" method="POST" action="/form/add_device.php" enctype="multipart/form-data">
              <div class="billing-details p-30">
                  ...
                  <div class="row" style="margin:20px 0px 0px 0px;">
                      ...
                      <div class="col-md-5">
                        <p style="margin:10px 0px 0px 0px;">용량크기 이름 <input type="text" style="margin:0px;" name="sizeName1" required></p>
                      </div>
                      <div class="col-md-2">
                        <p style="margin:10px 0px 0px 0px;">가격
                          <input type="text" style="margin:0px;" name="sizePrice1" required></p>
                        </p>
                      </div>
                      <div class="col-md-2">
                        <p style="margin:10px 0px 0px 0px;">&nbsp
                            <input class="submit-btn-1 mt-20 btn-hover-1 f-left" type="button" value="+" style="background:#333; cursor:pointer;" onclick="addSize()">
                        </p>
                      </div>
                      ...
                      <div class="col-md-5">
                        <p style="margin:10px 0px 0px 0px;">색상이름 <input type="text" name="colorName1" style="margin:0px;" required></p>
                      </div>
                      <div class="col-md-3">
                        <p style="margin:10px 0px 0px 0px;">이미지선택
                          <input type="file" name="colorImage1" style="margin:0px; padding:0px; height:40px; line-height:33px;" required>
                        </p>
                        <p style="margin:0px 0px 0px 0px; font-size:9px;">290*300px 권장 </p>
                      </div>
                      <div class="col-md-2">
                      ...
                      <div class="col-md-2">
                        <p style="margin:10px 0px 0px 0px;">&nbsp
                            <input class="submit-btn-1 mt-20 btn-hover-1 f-left" type="button" value="+" style="background:#333; cursor:pointer;" onclick="addColor()">
                        </p>
                      </div>
  ...
  function addColor(){
    $("#spec-wrap").before(
      ...
      "<div class=\"col-md-3\" id=\"color-row-image" + colorindex + "\">"+
        "<p style=\"margin:10px 0px 0px 0px;\">이미지선택"+
          "<input type=\"file\" name=\"colorImage" + colorindex + "\" style=\"margin:0px; padding:0px; height:40px; line-height:33px;\" required>"+
        "</p>"+
        "<p style=\"margin:0px 0px 0px 0px; font-size:9px;\">290*300px 권장 </p>"+
      "</div>"+
  ...
  function addSize(){
    $("#color-wrap").before(
      "<div class=\"col-md-5\" id=\"size-row-name" + sizeindex +"\">"+
        "<p style=\"margin:10px 0px 0px 0px;\">용량크기 이름 <input type=\"text\" style=\"margin:0px;\" name=\"sizeName" + sizeindex + "\" required></p>"+
      "</div>"+
