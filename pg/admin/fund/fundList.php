<div class="col-lg-9 order-lg-2 order-1">
    ...
    <form id="signForm" method="POST" action="/form/updateFund.php?support=fund" enctype="multipart/form-data" style="visibility:hidden;">
...
<script>
  ...
  <?php
    ...
    while ($row = $plans->fetch(PDO::FETCH_BOTH)){?>
      ...
      arr[2+deviceCnt].push("<?php echo $row['fund']?>");
      deviceCnt++;
      <?php
    }
    echo "search();"
