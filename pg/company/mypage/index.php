              ...
              <div class="billing-details p-10">
                  <div class="row" style="margin:10px 0px 0px 0px;">
                    <input type="text" style="display:none;" name="url"></p>
                      ...
                      <div class="col-md-5">
                        <p style="margin:10px 0px 0px 0px;">아이디<input type="text" style="margin:0px;" name="id" required readonly></p>
                      </div>
                      <div class="col-md-5">
                      ...
                      <div class="col-md-5">
                        <p style="margin:10px 0px 0px 0px;">코드
                          <input type="text" style="margin:0px;" name="code" required maxlength="5" minlength="4" placeholder="5자의 영어와 숫자" readonly>
                        </p>
                      </div>
                  </div>
                  <div class="row">
