                                                          ...
                                                          <tr>
                                                              <td class="product-thumbnail">
                                                                  <div class="pro-thumbnail-img">
                                                                      <img src="<?php $_SERVER['DOCUMENT_ROOT']?>/asset/img/cart/1.jpg" alt="">
                                                                  </div>
                                                                  ...
                                                                  <div id="collapseThree" class="panel-collapse collapse" >
                                                                      <div class="payment-content">
                                                                          ...
                                                                          <ul class="payent-type mt-10">
                                                                              <li><a href="#"><img src="<?php $_SERVER['DOCUMENT_ROOT']?>/asset/img/payment/1.png" alt=""></a></li>
                                                                              <li><a href="#"><img src="<?php $_SERVER['DOCUMENT_ROOT']?>/asset/img/payment/2.png" alt=""></a></li>
                                                                              <li><a href="#"><img src="<?php $_SERVER['DOCUMENT_ROOT']?>/asset/img/payment/3.png" alt=""></a></li>
                                                                              <li><a href="#"><img src="<?php $_SERVER['DOCUMENT_ROOT']?>/asset/img/payment/4.png" alt=""></a></li>
                                                                          </ul>
                                                                      </div>
                                                                  </div>
                                                              </div>
